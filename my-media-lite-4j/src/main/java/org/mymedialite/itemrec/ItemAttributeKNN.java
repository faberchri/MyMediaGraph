...
/**
 * k-nearest neighbor item-based collaborative filtering using cosine-similarity over the item attributes.
 * 
...
public class ItemAttributeKNN extends ItemKNN implements IItemAttributeAwareRecommender {
  ...
  public void setItemAttributes(SparseBooleanMatrix itemAttributes) {
    ...
    // TODO report this? Causes exceptions after loading modelS
